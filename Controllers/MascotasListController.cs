...
{
    public class MascotasListController: Controller
    {
        private readonly ILogger<MascotasListController> _logger;
        private readonly ApplicationDbContext _context;
        private readonly UserManager<IdentityUser> _userManager;

        public MascotasListController(ApplicationDbContext context,ILogger<MascotasListController> logger,UserManager<IdentityUser> userManager){
            _context = context;
            _logger = logger;
